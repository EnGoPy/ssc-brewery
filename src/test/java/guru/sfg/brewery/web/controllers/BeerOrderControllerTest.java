...
public class BeerOrderControllerTest extends BaseIT {
    ...
    @WithUserDetails("spring") //alternatywna droga do logowania się przy httpBasic
    @Test
    ...
    @WithUserDetails(DefaultBreweryLoader.STPETE_USER)
    @Test
    void getByOrderICustomerAuth() throws Exception{
        BeerOrder beerOrder = stPeteCustomer.getBeerOrders().stream().findFirst().orElseThrow();
    ...
    @Test
    void getByOrderICustomerNOTAuth() throws Exception{
        BeerOrder beerOrder = stPeteCustomer.getBeerOrders().stream().findFirst().orElseThrow();
    ...
    void pickUpOrderNotAuth() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put(
                API_ROOT + stPeteCustomer.getId() + "/orders/" +
